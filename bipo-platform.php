...
<html lang="en">
   ...
   <body>
      ...
      ============================== -->
      <div class="page-title-area service-area-outsource-bi-bg">
         <div class="container">
            <div class="row">
               <div class="col-sm-6 col-md-6">
                  <div class="page-title-left">
                     <h2>BIPO HRMS Solutions</h2>
                  </div>
               </div>
               <div class="col-sm-6 col-md-6">
                  <div class="page-bredcrumbs-area text-right">
                     <ul  class="page-bredcrumbs">
                        ...
                        <li><a href="#">BIPO HRMS Solutions</a></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <section class="service-area service-page-section">
         <div class="service-content-area">
	         <div class="container">
	        		<div class="row">
                 <?php include 'products-sidebar-platform.php';?>
