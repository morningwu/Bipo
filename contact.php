...
<html lang="en">
   ...
   <body>
      ...
      ============================== -->
      <div class="page-title-area contact-bg">
         <div class="container">
            <div class="row">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="contact-form-left contact-form-3 contact-form-right">
                      ...
                      <img src="images/BIPOCHINA_QR_RGB.PNG" class="text-center col-sm-12 col-xs-12 col-md-12">
                    </div>
                  </div>
                  <div class="col-sm-9">
                     <div class="contact-form-left contact-form-3 contact-form-right">
                        ...
                        <form>
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Interested services" placeholder="Interested services">
                              </div>
                              <div class="col-sm-6">
                                 <select name="respond-time" class="form-control">
                                    <option>Expected time to call </option>
